"""
Django settings for procesory_contextu project.
...
SECRET_KEY = "django-insecure-roujzi0a2*i3+92qands8(#sy-!h=i7)3zvqg4#uu@g6m%a(-l"
...
WSGI_APPLICATION = "procesory_contextu.wsgi.application"
